...
def test_apply_evaluator_overrides_can_disable_cross_encoder_and_learned_ranker() -> None:
    config = AppConfig()
    ...
    assert updated.cross_encoder.enabled is False
    assert updated.learned_ranker.shadow_enabled is False
    assert updated.learned_ranker.active_enabled is False

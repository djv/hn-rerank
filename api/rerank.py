    ...
    def encode(
        ...
        for i in range(0, total_items, batch_size):
            ...
            if normalize_embeddings:
                ...
                batch_embeddings = batch_embeddings / np.clip(norm, a_min=EMBEDDING_MIN_CLIP, a_max=None)
...
def rank_stories(
    ...
    for _ in range(min(len(stories), 100)): # Rank top 100
        ...
        results.append((best_idx, float(hybrid_scores[best_idx]), int(best_fav_indices[best_idx])))

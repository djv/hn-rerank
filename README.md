...
- Built-in extra feeds:
  `jack-clark.net`, `lobste.rs`, `tildes.net`, `lesswrong.com`, `Slashdot`, GitHub Trending, `r/MachineLearning`, `r/programming`, and `r/compsci` are appended to the OPML feed set.
- Browser dependency:
